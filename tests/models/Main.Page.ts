...
export class MainPage {
  ...
  async clikSwitchLightModeIcon() {
    await this.page.getByLabel('Switch between dark and light').dblclick();
  }
  async chekDataThemeAttributeValue() {
  ...
  async checkLayoutWithDarkMode() {
    await expect(this.page).toHaveScreenshot(`pageWithDarktMode.png`);
  }
}